 ...
 * @since 11
 */
public class QueueTrackExecutor extends AbstractTrackExecutor {
	...
	public QueueTrackExecutor(String name, int nThreads, RejectedTrackExecutionHandler rejectedHandler) {
